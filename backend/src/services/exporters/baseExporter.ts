...
export abstract class BaseExporter {
    ...
    protected abstract updateListingOnApi(accessToken: string, externalId: string, updates: { price?: number; quantity?: number; title?: string; description?: string; sku?: string; weight?: number; images?: string[]; shipping_type?: string; ean?: string }, credentials?: any): Promise<ExportResult>;
